...
<template>
  <div class="w-full flex justify-center">
    ...
    >
      ...
      <button class=" hidden md:inline bg-blue-500 text-white w-1/5 font-semibold font-size 1 py-2 px-4 rounded hover:bg-blue-600 transition duration-300 ease-in-out"  @click="searchSpells">
        НАЙТИ
      </button>
